...
/**
 * Strings for component 'theme_boost_magnific', language 'bg'
 *
...
$string['choosereadme'] = 'boost_magnific es un tema creado con cariño para llevar colores alegres a Moodle.';
