...
function get_generated_image_for_id(int $courseid, int $height = 300, int $width = 600): string {
    ...
    $imagelist = glob("{$CFG->dirroot}/theme/boost_magnific/pix/generated/*.png");
    if (empty($imagelist)) {
        throw new coding_exception("No generated images found in theme/boost_magnific/pix/generated/.");
    }
