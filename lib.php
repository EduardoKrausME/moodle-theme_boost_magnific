...
/**
 * Function theme_boost_magnific_process_color_hex
 *
 * @param $colorname
 *
 * @return string
...
function theme_boost_magnific_process_css($css, $theme) {
    ...
    if (@file_exists(__DIR__ . "/style/boost_magnific.css")) {
        $customcss = file_get_contents(__DIR__ . "/style/boost_magnific.css");
    ...
    if ($CFG->theme != "boost_training") {
        $topscrollbackgroundcolor = theme_boost_magnific_get_setting("top_scroll_background_color");
        $topscrolltextcolor = theme_boost_magnific_get_setting("top_scroll_text_color");
