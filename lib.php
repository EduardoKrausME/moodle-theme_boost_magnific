...
function theme_boost_magnific_process_css($css, $theme) {
    ...
    $top_scroll_background_color = theme_boost_magnific_get_setting("top_scroll_background_color");
    $top_scroll_text_color_desc = theme_boost_magnific_get_setting("top_scroll_text_color_desc");
