...
if ($action == "langedit") {
    ...
    $DB->update_record("theme_boost_magnific_pages", $page);
    ...
    set_config("homemode", $homemode, "theme_boost_magnific");
    ...
    $orders = theme_boost_magnific_clear_params_array($_POST["order"], PARAM_INT);
    ...
    if (isset($_FILES['files']['name'])) {
        ...
        if (in_array($extension, $aloweb)) {
            ...
            $url = moodle_url::make_file_url(
                ...
                "/{$context->id}/theme_boost_magnific/{$filerecord->filearea}/{$filerecord->itemid}{$filerecord->filepath}{$filerecord->filename}"
            );
    ...
    foreach ($files as $file) {
        $url = moodle_url::make_file_url(
            "{$CFG->wwwroot}/pluginfile.php",
            "/{$context->id}/theme_boost_magnific/{$file->get_filearea()}/{$file->get_itemid()}{$file->get_filepath()}{$file->get_filename()}"
        );
        $items[] = [
            "id" => $file->get_id(),
