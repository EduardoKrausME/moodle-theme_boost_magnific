...
$html = "";
if ($page == "webpages") {
    $html = $DB->get_field("boost_magnific_webpages", "text", ["id" => $id]);
} else if ($page == "notification") {
    $html = $DB->get_field("boost_magnific_events", "message", ["id" => $id]);
} else if ($page == "aceite") {
    $html = get_config('theme_boost_magnific', 'formulario_pedir_aceite');
} else if ($page == "meiodeposito") {
    $html = get_config('theme_boost_magnific', 'kopere_pay-meiodeposito-conta');
}
