    ...
    html      : `
	  <div class="swiper" data-slides-per-view="3" data-draggable="true">
		<div class="swiper-wrapper">
		  <div class="swiper-slide"><img src="${wwwroot}/theme/boost_magnific/_editor/media/4.jpg" class="img-fluid"><p>Slide 1</p></div>
		  <div class="swiper-slide"><img src="${wwwroot}/theme/boost_magnific/_editor/media/2.jpg" class="img-fluid"><p>Slide 2</p></div>
		  <div class="swiper-slide"><img src="${wwwroot}/theme/boost_magnific/_editor/media/5.jpg" class="img-fluid"><p>Slide 3</p></div>
		  <div class="swiper-slide"><img src="${wwwroot}/theme/boost_magnific/_editor/media/7.jpg" class="img-fluid"><p>Slide 4</p></div>
		</div>
...
Vvveb.Components.add("elements/slider", {
    ...
    html      : `
	  <div class="swiper" data-slides-per-view="1" data-draggable="true" data-navigation='{"nextEl": ".swiper-button-next","prevEl": ".swiper-button-prev"}'>
		<div class="swiper-wrapper">
		  <div class="swiper-slide"><img src="${wwwroot}/theme/boost_magnific/_editor/media/posts/1.jpg" class="img-fluid"><p>Slider 1</p></div>
		  <div class="swiper-slide"><img src="${wwwroot}/theme/boost_magnific/_editor/media/posts/2.jpg" class="img-fluid"><p>Slider 2</p></div>
		  <div class="swiper-slide"><img src="${wwwroot}/theme/boost_magnific/_editor/media/posts/3.jpg" class="img-fluid"><p>Slider 3</p></div>
		  <div class="swiper-slide"><img src="${wwwroot}/theme/boost_magnific/_editor/media/posts/4.jpg" class="img-fluid"><p>Slider 4</p></div>
		</div>
		<div class="swiper-pagination"></div>
