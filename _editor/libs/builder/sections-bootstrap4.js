...
<div class="video header-video" data-name="header-video">
  ...
  <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
    <source src="${wwwroot}/theme/boost_magnific/_editor/media/sample.webm" poster="${wwwroot}/theme/boost_magnific/_editor/media/sample.webp" type="video/mp4" controls>
  </video>
