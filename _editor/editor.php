...
use theme_boost_magnific\page_editor_manager;
...
$PAGE->set_url(new moodle_url("/theme/boost_magnific/_editor/editor.php", $_GET));

if (optional_param("delete", false, PARAM_INT)) {
    $dataid = required_param("dataid", PARAM_INT);

    $PAGE->set_pagelayout("standard");
    $PAGE->set_title(get_string("delete_block_title", "theme_boost_magnific"));
    $PAGE->set_heading(get_string("delete_block_title", "theme_boost_magnific"));

    echo $OUTPUT->header();
    $confirm = md5($dataid . $CFG->wwwroot);
    if (optional_param("confirm", false, PARAM_TEXT) == $confirm) {
        $deletedpage = $DB->get_record("theme_boost_magnific_pages", ["id" => $dataid], "*", MUST_EXIST);
        $DB->delete_records("theme_boost_magnific_pages", ["id" => $dataid]);
        ...
        if ($returnurl) {
            redirect(new moodle_url($returnurl), get_string("delete_block_success", "theme_boost_magnific"));
        }
        redirect($CFG->wwwroot, get_string("delete_block_success", "theme_boost_magnific"));
    } else {
        $returnurl = optional_param("returnurl", "", PARAM_LOCALURL);
        $deleteurl = new moodle_url("/theme/boost_magnific/_editor/editor.php", [
            "dataid" => $dataid,
            "delete" => 1,
            "confirm" => $confirm,
        ]);
        ...
        echo "
            <p>" . get_string("delete_block_confirm", "theme_boost_magnific") . "</p>
            <div class=\"d-flex\">
...
if (required_param("dataid", PARAM_TEXT) == "create") {
    ...
    redirect(new moodle_url("/theme/boost_magnific/_editor/editor.php", $params));
    die;
}

$dataid = required_param("dataid", PARAM_INT);
$page = $DB->get_record("theme_boost_magnific_pages", ["id" => $dataid], "*", MUST_EXIST);
        ...
        <div id="form-itens" class="form-itens-<?php echo $page->type; ?>">
            <h3 class="d-flex align-items-center gap-2">
                ...
                <select class="form-control" id="change-lang" style="width: auto;">
                    <?php
                    echo "<option value=\"all\">" . get_string("language_all", "theme_boost_magnific") . "</option>\n";
            ...
            <div id="botoes-editor-action" class="f-flex mt-3 form-itens-<?php echo $page->type; ?>">
                ...
                <button id="btn-add-block" type="button" class="btn btn-secondary me-3" style="display:none">
                    <?php echo get_string("add_block", "theme_boost_magnific") ?></button>
            </div>
        </div>
                    ...
                    globalPageSettings: {
                        fonts: {
                            Roboto: {
                                variants: {
                                    regular: {
                                         source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Roboto/Roboto-normal-400.woff'
                                    },
                                    bold: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Roboto/Roboto-normal-700.woff'
                                    }
                                }
                            },
                            'Open Sans': {
                                variants: {
                                    regular: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Open-Sans/Open-Sans-italic-400.woff'
                                    },
                                    bold: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Open-Sans/Open-Sans-italic-700.woff'
                                    }
                                }
                            },
                            Montserrat: {
                                variants: {
                                    regular: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Montserrat/Montserrat-normal-400.woff'
                                    },
                                    bold: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Montserrat/Montserrat-normal-700.woff'
                                    }
                                }
                            },
                            Poppins: {
                                variants: {
                                    regular: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Poppins/Poppins-normal-400.woff'
                                    },
                                    bold: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Poppins/Poppins-normal-700.woff'
                                    }
                                }
                            },
                            Lato: {
                                variants: {
                                    regular: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Lato/Lato-normal-400.woff'
                                    },
                                    bold: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Lato/Lato-normal-700.woff'
                                    }
                                }
                            },
                            'Playfair Display': {
                                variants: {
                                    regular: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Playfair-Display/Playfair-Display-italic-400.woff'
                                    },
                                    bold: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Playfair-Display/Playfair-Display-italic-700.woff'
                                    }
                                }
                            },
                            Merriweather: {
                                variants: {
                                    regular: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Merriweather/Merriweather-normal-400.woff'
                                    },
                                    bold: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Merriweather/Merriweather-normal-700.woff'
                                    }
                                }
                            },
                            Raleway: {
                                variants: {
                                    regular: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Raleway/Raleway-normal-400.woff'
                                    },
                                    bold: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Raleway/Raleway-normal-700.woff'
                                    }
                                }
                            },
                            Oswald: {
                                variants: {
                                    regular: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Oswald/Oswald-normal-400.woff'
                                    },
                                    bold: {
                                        source: '<?php echo $CFG->wwwroot ?>/theme/font.php/boost_magnific/theme/<?php echo theme_get_revision() ?>/Oswald/Oswald-normal-700.woff'
                                    }
                                }
                            }
                        }
