...
// Logos section.
$page = new admin_settingpage("theme_boost_magnific_logos",
    get_string("logossettings", "admin"));

$url = "{$CFG->wwwroot}/theme/boost_magnific/quickstart/#logos";
$setting = new admin_setting_heading("theme_boost_magnific_quickstart_logos", "",
