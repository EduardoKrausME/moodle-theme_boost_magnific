...
$page = new admin_settingpage("theme_boost_magnific_footer",
    get_string("footersettings", "theme_boost_magnific"));

$url = "{$CFG->wwwroot}/theme/boost_magnific/quickstart/#footer";
$setting = new admin_setting_heading("theme_boost_magnific_quickstart_footer", "",
...
for ($i = 1; $i <= 4; $i++) {
    ...
    $setting = new admin_setting_heading("theme_boost_magnific_footer_heading_{$i}",
        get_string("footer_heading", "theme_boost_magnific", $i), "");
    $page->add($setting);
...
$setting = new admin_setting_heading('theme_boost_magnific_footerblock_copywriter',
    get_string('footer_copywriter', 'theme_boost_magnific'), '');
$page->add($setting);

$setting = new admin_setting_configcheckbox(
    'theme_boost_magnific/footer_show_copywriter', get_string('footer_show_copywriter', 'theme_boost_magnific'),
