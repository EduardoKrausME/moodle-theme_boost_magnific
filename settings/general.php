...
if (!isset($config->startcolor[2])) {
    $htmlselect .= "\n\n" . $OUTPUT->render_from_template("theme_boost_magnific/settings/colors", [
            ...
            "defaultcolor" => theme_boost_magnific_default_color("startcolor", "#1a2a6c"),
        ]);

    $setting = new admin_setting_configtext("theme_boost_magnific/startcolor",
        get_string("brandcolor", "theme_boost"),
        get_string("brandcolor_desc", "theme_boost_magnific") . $htmlselect,
        "#1a2a6c");
    ...
    $setting = new admin_setting_configtext("theme_boost/brandcolor",
        get_string("brandcolor", "theme_boost_magnific"),
        get_string("brandcolor_desc", "theme_boost_magnific") . $htmlselect,
        "#1a2a6c");
    $setting->set_updatedcallback("theme_boost_magnific_change_color");
    $page->add($setting);
