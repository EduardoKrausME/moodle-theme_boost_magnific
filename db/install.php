...
function xmldb_theme_boost_magnific_install() {
    ...
    set_config("background_image", "math-black", "theme_boost_magnific");
    set_config("background_color", "#2B4E84", "theme_boost_magnific");
    set_config("theme", "theme_blue", "theme_boost_magnific");
    set_config("color_primary", "#2B4E84", "theme_boost_magnific");
    set_config("color_secondary", "#3E65A0", "theme_boost_magnific");
    set_config("color_buttons", "#183054", "theme_boost_magnific");
    set_config("color_names", "#C0CCDC", "theme_boost_magnific");
    set_config("color_titles", "#E8F0FB", "theme_boost_magnific");
