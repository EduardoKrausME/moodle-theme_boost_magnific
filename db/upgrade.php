...
function xmldb_theme_boost_magnific_upgrade($oldversion) {
    ...
    if (get_config("theme_boost_magnific", "home_type") != 0) {
        ...
        if (get_config("theme_boost_magnific", "frontpage_about_enable")) {
            $frontpage_about_logo = get_config("theme_boost_magnific", "frontpage_about_logo");
            $frontpage_about_title = get_config("theme_boost_magnific", "frontpage_about_title");
            $frontpage_about_description = get_config("theme_boost_magnific", "frontpage_about_description");
            ...
            for ($i = 1; $i <= 4; $i++) {
                $frontpage_about_text = get_config("theme_boost_magnific", "frontpage_about_text_{$i}");
                $frontpage_about_number = get_config("theme_boost_magnific", "frontpage_about_number_{$i}");
 ...
 * @throws Exception
 */
function theme_boost_magnific_generate_links($menustr = "") {
    $htmlstr = "";
