...
$numblocks = 0;
for ($i = 1; $i <= 4; $i++) {
    $footertitle = get_config("theme_boost_magnific", "footer_title_{$i}");
    $footerhtml = get_config("theme_boost_magnific", "footer_html_{$i}");
...
if (file_exists("{$CFG->libdir}/editor/tiny/lib.php")) {
    $footermustache = [
        ...
        "htmlselect" => $OUTPUT->render_from_template("theme_boost_magnific/settings/colors", [
            ...
            "defaultcolor" => theme_boost_magnific_default_color("brandcolor", "#1a2a6c"),
        ]), "blocks" => [
            [
                "num" => 1, "active" => true, "footer_title" => get_config("theme_boost_magnific", "footer_title_1"),
                "footer_html" => get_config("theme_boost_magnific", "footer_html_1"),
            ], [
                "num" => 2, "footer_title" => get_config("theme_boost_magnific", "footer_title_2"),
                "footer_html" => get_config("theme_boost_magnific", "footer_html_2"),
            ], [
                "num" => 3, "footer_title" => get_config("theme_boost_magnific", "footer_title_3"),
                "footer_html" => get_config("theme_boost_magnific", "footer_html_3"),
            ], [
                "num" => 4, "footer_title" => get_config("theme_boost_magnific", "footer_title_4"),
