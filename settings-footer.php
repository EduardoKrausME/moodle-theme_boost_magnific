...
if (get_config('theme_boost_magnific', 'footer_type') != 0) {
    ...
    $html = "<a class='btn btn-info mt-1 mb-2' target='_blank'
                href='{$CFG->wwwroot}/theme/boost_magnific/_editor/?chave=footer&lang=all'>{$text}</a>";
    ...
    if ($CFG->langmenu) {
        ...
        $html = "<a class='btn btn-info mt-1 mb-2' target='_blank'
                    href='{$CFG->wwwroot}/theme/boost_magnific/_editor/?chave=footer&lang={$CFG->lang}'>{$text}</a>";
        ...
        foreach ($listoftranslations as $langkey => $langname) {
            ...
            $html = "<a class='btn btn-info mt-1' target='_blank'
                        href='{$CFG->wwwroot}/theme/boost_magnific/_editor/?chave=footer&lang={$langkey}'>{$text}</a>";
