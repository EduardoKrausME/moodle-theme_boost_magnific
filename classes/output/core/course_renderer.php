...
class course_renderer extends \core_course_renderer {
        ...
        foreach ($courses as $course) {
            ...
            if (file_exists("{$CFG->dirroot}/local/kopere_pay/lib.php")) {
                ...
                if ($koperepaydetalhe && $koperepaydetalhe->course) {
                    ...
                    if ($preco <= 5) {
                        $freename = "<a href='{$viewurl}'>" . get_string("free_name", "theme_boost_magnific") . "</a>";
                    } else {
            ...
            $datacursos["courses"][] = [
                ...
                "access_course" => get_string("access_course", "theme_boost_magnific"),
                "matricular" =>
                    $priceval ? get_string("matricular", "theme_boost_magnific") : get_string("access_course", "theme_boost_magnific"),
                "freename" => $freename,
                "priceval" => $priceval,
            ];
        }

        return $this->output->render_from_template('theme_boost_magnific/frontpage-courselist', $datacursos);
    }
    ...
    public function frontpage_my_courses() {
        ...
        foreach ($courses as $course) {
            ...
            $datacursos["courses"][] = [
                ...
                "instructor" => course_renderer_util::get_teachers($course),
                "is_enrolled" => true,
                "access_course" => get_string("continuar", "theme_boost_magnific"),
            ];
        }
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
        ...
        return $this->output->render_from_template('theme_boost_magnific/frontpage-course', $datacurso);
    }
    ...
    public function course_search_form($value = '') {
        ...
        return $this->render_from_template('theme_boost_magnific/frontpage-search', $data);
    }
