...
class navbar implements \renderable {
    ...
    protected function load_breadcrumb_settings(): void {
        $this->breadcrumbsettings = [
            "showmycoursescourses" => get_config("theme_boost_magnific", "breadcrumb_show_mycourses_courses"),
            "showcategories" => get_config("theme_boost_magnific", "breadcrumb_show_categories"),
            "showcourse" => get_config("theme_boost_magnific", "breadcrumb_show_course"),
            "shownavigationduplicates" => get_config("theme_boost_magnific", "breadcrumb_show_navigation_duplicates"),
            "showsections" => get_config("theme_boost_magnific", "breadcrumb_show_sections"),
            "shownolinkitems" => get_config("theme_boost_magnific", "breadcrumb_show_no_link_items"),
        ];
    }
