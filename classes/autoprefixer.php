...
class autoprefixer {
    ...
    public function __construct(Document $tree) {
        debugging('theme_boost_magnific\autoprefixer() is deprecated. Required prefixes for Bootstrap ' .
            'are now in theme/boost_magnific/scss/moodle/prefixes.scss', DEBUG_DEVELOPER);
        $this->tree = $tree;
