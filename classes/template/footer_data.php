...
class footer_data {
    ...
    private static function description() {
        ...
        return [
            'enable_block_description' => 0 + ($footerdescription != ''),
    ...
    private static function social() {
        ...
        $socialfacebook = theme_boost_magnific_get_setting('social_facebook');
        $socialfacebook = trim($socialfacebook);
        $socialtwitter = theme_boost_magnific_get_setting('social_twitter');
        $socialtwitter = trim($socialtwitter);
        $socialinstagram = theme_boost_magnific_get_setting('social_instagram');
        $socialinstagram = trim($socialinstagram);

        $socialurls = ($socialfacebook != '' || $socialinstagram != '' || $socialtwitter != '') ? 1 : 0;

        return [
            'enable_block_social' => $socialurls,
            'footer_social_title' => $footersocialtitle,
            'social_facebook' => $socialfacebook,
            'social_instagram' => $socialinstagram,
            'social_twitter' => $socialtwitter,
            'instagram_name' => get_string("social_instagram", 'theme_boost_magnific'),
            'twitter_name' => get_string("social_twitter", 'theme_boost_magnific'),
            'facebook_name' => get_string("social_facebook", 'theme_boost_magnific'),
        ];
    }
