<?php
// This file is part of the theme_boost_magnific plugin for Moodle - http://moodle.org/
//
...
namespace theme_boost_magnific\fonts;

defined('MOODLE_INTERNAL') || die;

global $CFG;
require_once("{$CFG->dirroot}/theme/boost_magnific/classes/fonts/font_attributes.php");
...
class font_util {
    ...
    public static function list_fonts() {
        ...
        $fontsitens = [];
        $fontfiles = glob("{$CFG->dirroot}/theme/boost_magnific/_editor/fonts/*/*.ttf");
