...
/**
 * Privacy Subsystem implementation for theme_boost_magnific.
 *
...
namespace theme_boost_magnific\privacy;
...
class provider implements
    ...
    const ACCESSIBILITY_LOG_TABLE = 'theme_boost_magnific_accesslog';
    ...
    public static function get_metadata(collection $items): collection {
        ...
        $items->add_database_table(self::ACCESSIBILITY_LOG_TABLE, [
            'userid' => 'privacy:metadata:theme_boost_magnific_accesslog:userid',
            'courseid' => 'privacy:metadata:theme_boost_magnific_accesslog:courseid',
            'cmid' => 'privacy:metadata:theme_boost_magnific_accesslog:cmid',
            'action' => 'privacy:metadata:theme_boost_magnific_accesslog:action',
            'item' => 'privacy:metadata:theme_boost_magnific_accesslog:item',
            'status' => 'privacy:metadata:theme_boost_magnific_accesslog:status',
            'activeitems' => 'privacy:metadata:theme_boost_magnific_accesslog:activeitems',
            'statejson' => 'privacy:metadata:theme_boost_magnific_accesslog:statejson',
            'pageurl' => 'privacy:metadata:theme_boost_magnific_accesslog:pageurl',
            'timecreated' => 'privacy:metadata:theme_boost_magnific_accesslog:timecreated',
        ], 'privacy:metadata:theme_boost_magnific_accesslog');
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        writer::with_context(context_system::instance())->export_data(
            [get_string('privacy:accessibilitylogpath', 'theme_boost_magnific')],
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_boost_magnific');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_boost_magnific');
            }
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_boost_magnific');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_boost_magnific');
            }
            writer::export_user_preference(
                'theme_boost_magnific',
