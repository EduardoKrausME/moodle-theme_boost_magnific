    ...
    var frontpage = {
        ...
        add_block_modal_init: function (lang) {
            async function loadFiles() {
                const response = await fetch(`${M.cfg.wwwroot}/theme/boost_magnific/_editor/model/?lang=${lang}`);
                ...
                Object.values(groups).forEach(function (grupo) {
                    ...
                    grupo.forEach(function (item) {
                        ...
                        block.click(function () {
                            location.href = `${M.cfg.wwwroot}/theme/boost_magnific/_editor/editor.php?lang=${lang}&local=home&dataid=create&template=${item.id}`;
                        });
                    });
                });
            }
        ...
        block_order_save_order: function () {
            ...
            $.ajax({
                url: `${M.cfg.wwwroot}/theme/boost_magnific/_editor/actions.php?action=page-order&local=home`,
                type: 'POST',
                data: {
                    order: order,
