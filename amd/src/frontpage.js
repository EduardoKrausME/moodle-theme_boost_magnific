    ...
    var frontpage = {
        ...
        add_block_modal_init: function () {
            async function loadFiles() {
                const response = await fetch(`${M.cfg.wwwroot}/theme/boost_magnific/_editor/model/?lang=${frontpage.lang}`);
        ...
        buildEditorCreateUrl: function (template) {
            ...
            return `${M.cfg.wwwroot}/theme/boost_magnific/_editor/editor.php?${params.toString()}`;
        },
        ...
        block_order_save_order: function () {
            ...
            $.ajax({
                url: `${M.cfg.wwwroot}/theme/boost_magnific/_editor/actions.php?action=page-order&local=${encodeURIComponent(frontpage.local)}`,
                type: "POST",
                data: {
                    order: order,
