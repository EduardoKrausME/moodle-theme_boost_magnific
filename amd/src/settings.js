define(["jquery", "theme_boost_magnific/minicolors"], function($, minicolors) {
    var theme_boost_magnific = {
        ...
        theme_color : function() {
            $(".boost_magnific-seletor-de-theme").click(function() {
                ...
                $("#id_s_theme_boost_magnific_theme_color__color_primary")
                    .val(color_primary)
                    .minicolors('settings', {value : color_primary});
                $("#id_s_theme_boost_magnific_theme_color__color_secondary")
                    .val(color_secondary)
                    .minicolors('settings', {value : color_secondary});
                $("#id_s_theme_boost_magnific_theme_color__color_buttons")
                    .val(color_buttons)
                    .minicolors('settings', {value : color_buttons});
                $("#id_s_theme_boost_magnific_theme_color__color_names")
                    .val(color_names)
                    .minicolors('settings', {value : color_names});
                $("#id_s_theme_boost_magnific_theme_color__color_titles")
                    .val(color_titles)
