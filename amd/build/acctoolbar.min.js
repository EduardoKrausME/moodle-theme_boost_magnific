define([],function(){return{init:function(iconurl){window.micAccessTool=new MicAccessTool(iconurl,{toolbar:M.util.get_string("acctoolbar_toolbar","theme_boost_magnific"),btn_open:M.util.get_string("acctoolbar_btn_open","theme_boost_magnific"),btn_close:M.util.get_string("acctoolbar_btn_close","theme_boost_magnific"),keyboard_root:M.util.get_string("acctoolbar_keyboard_root","theme_boost_magnific"),disable_animattions:M.util.get_string("acctoolbar_disable_animattions","theme_boost_magnific"),dyslexic:M.util.get_string("acctoolbar_dyslexic","theme_boost_magnific"),access_declaration:M.util.get_string("acctoolbar_access_declaration","theme_boost_magnific"),debug_contacts:M.util.get_string("acctoolbar_debug_contacts","theme_boost_magnific"),reset_all_settings:M.util.get_string("acctoolbar_reset_all_settings","theme_boost_magnific"),image_without_alt:M.util.get_string("acctoolbar_image_without_alt","theme_boost_magnific"),contrast_block:{header:M.util.get_string("acctoolbar_contrast_block_header","theme_boost_magnific"),btn_monochrome:M.util.get_string("acctoolbar_btn_monochrome","theme_boost_magnific"),btn_bright:M.util.get_string("acctoolbar_btn_bright","theme_boost_magnific"),btn_invert:M.util.get_string("acctoolbar_btn_invert","theme_boost_magnific")},text_block:{header:M.util.get_string("acctoolbar_text_block_header","theme_boost_magnific"),btn_font_up:M.util.get_string("acctoolbar_btn_font_up","theme_boost_magnific"),btn_font_down:M.util.get_string("acctoolbar_btn_font_down","theme_boost_magnific"),btn_font_readable:M.util.get_string("acctoolbar_btn_font_readable","theme_boost_magnific")},content_block:{header:M.util.get_string("acctoolbar_content_block_header","theme_boost_magnific"),btn_underline_links:M.util.get_string("acctoolbar_btn_underline_links","theme_boost_magnific"),btn_underline_headers:M.util.get_string("acctoolbar_btn_underline_headers","theme_boost_magnific"),btn_images_titles:M.util.get_string("acctoolbar_btn_images_titles","theme_boost_magnific")},zoom_block:{header:M.util.get_string("acctoolbar_zoom_block_header","theme_boost_magnific"),btn_cursor_white:M.util.get_string("acctoolbar_btn_cursor_white","theme_boost_magnific"),btn_cursor_black:M.util.get_string("acctoolbar_btn_cursor_black","theme_boost_magnific"),btn_zoom_in:M.util.get_string("acctoolbar_btn_zoom_in","theme_boost_magnific")}})}}});function MicAccessTool(iconurl,locale){this.init={iconurl:iconurl,link:"",contact:"",buttonPosition:"right"};this.locale=locale;this.buildToolBox();this.toolBox=document.getElementById("mic-access-tool-box");this.toolBoxOpenButton=document.getElementById("mic-access-tool-general-button");this.toolBoxCloseButton=document.getElementById("mic-access-tool-box-close-button");this.toolBoxOpenButton.addEventListener("click",this.openBox.bind(this));this.toolBoxCloseButton.addEventListener("click",this.closeBox.bind(this));document.addEventListener("keyup",this.openCloseBoxKeyboard.bind(this));this.micContrastMonochrome=document.getElementById("mic-toolbox-contrast-monochrome");this.micContrastSoft=document.getElementById("mic-toolbox-contrast-soft");this.micContrastHard=document.getElementById("mic-toolbox-contrast-hard");this.micContrastMonochrome.addEventListener("click",this.contrastChange);this.micContrastSoft.addEventListener("click",this.contrastChange);this.micContrastHard.addEventListener("click",this.contrastChange);this.micDisableButtonsAnimations=document.getElementById("mic-toolbox-disable-buttons-animations");this.micDisableButtonsAnimations.addEventListener("click",this.onceButtonChange);this.micdyslexic=document.getElementById("mic-dyslexic-buttons");this.micdyslexic.addEventListener("click",this.onceButtonChange);this.micDisableButtonsKeyboard=document.getElementById("mic-toolbox-disable-buttons-keyboard");this.micDisableButtonsKeyboard.addEventListener("click",this.onceButtonChange);this.micToolboxFontsUp=document.getElementById("mic-toolbox-fonts-up");this.micToolboxFontsDown=document.getElementById("mic-toolbox-fonts-down");this.micToolboxFontsSimple=document.getElementById("mic-toolbox-fonts-simple");this.micToolboxFontsUp.addEventListener("click",this.fontsChange);this.micToolboxFontsDown.addEventListener("click",this.fontsChange);this.micToolboxFontsSimple.addEventListener("click",this.onceButtonChange);this.micToolboxContentLinks=document.getElementById("mic-toolbox-content-links");this.micToolboxContentHeaders=document.getElementById("mic-toolbox-content-headers");this.micToolboxContentImages=document.getElementById("mic-toolbox-content-images");this.micToolboxContentLinks.addEventListener("click",this.onceButtonChange);this.micToolboxContentHeaders.addEventListener("click",this.onceButtonChange);this.micToolboxContentImages.addEventListener("click",this.onceButtonChange);this.micToolboxCursorWhite=document.getElementById("mic-toolbox-cursor-big-white");this.micToolboxCursorBlack=document.getElementById("mic-toolbox-cursor-big-black");this.micToolboxZoomUp=document.getElementById("mic-toolbox-zoom-up");this.micToolboxCursorWhite.addEventListener("click",this.cursorChange);this.micToolboxCursorBlack.addEventListener("click",this.cursorChange);this.micToolboxZoomUp.addEventListener("click",this.onceButtonChange);this.micToolboxDisableButtonsAll=document.getElementById("mic-toolbox-disable-buttons-reset-all");this.micToolboxDisableButtonsAll.addEventListener("click",this.resetApp.bind(this));this.initialApp()}MicAccessTool.prototype.buildToolBox=function(){var o=`
