...
if (optional_param("embed-frame-top", 0, PARAM_INT)) {
    ...
    $templatecontext["footer_background_color"] =
        theme_boost_magnific_default_color("footer_background_color", $brandcolor);
    $templatecontext["footer_background_text_color"] =
        theme_boost_magnific_get_footer_color($templatecontext["footer_background_color"], "#333", false);
    ...
    $templatecontext["footer_show_copywriter"] = get_config("theme_boost_magnific", "footer_show_copywriter");
