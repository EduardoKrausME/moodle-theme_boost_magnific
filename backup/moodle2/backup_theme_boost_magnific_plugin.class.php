...
/**
 * backup_theme_boost_magnific_plugin.class.php
 *
 ...
 */
class backup_theme_boost_magnific_module_element extends backup_nested_element {
...
class backup_theme_boost_magnific_plugin extends backup_theme_plugin {
    ...
    /**
     * Defines the course-level structure for theme_boost_magnific data.
     *
    ...
    protected function define_course_plugin_structure() {
        ...
        $plugin = $this->get_plugin_element(null, $this->get_theme_condition(), "boost_magnific");
     ...
     LEFT JOIN {config_plugins} bfile
        ...
        $moduleopt = new backup_theme_boost_magnific_module_element("moduleopt", ["cmid"], [
            "contextid",
            "customimage",
            "customicon",
            "customcolor",
